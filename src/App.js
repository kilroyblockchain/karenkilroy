...
const Portfolio = () => {
  ...
  const speakingHighlights = [
    ...
    },
    {
      ...
      topic: "C2PA Content Credentials for Open Claw AI Agents",
      description:
        "Hands-on training on ad-hoc trust networks for AI Club with 175+ student, faculty, and community attendees."
    }
  ];
