      ...
      <main className="container" role="main" aria-label="Agentic AI platform resume of Karen Kilroy">
        ...
        <section className="section summary-section" aria-labelledby="summary-heading">
          ...
          <p className="summary">
            ...
            Supply chain grounding through IBM programs and enterprise traceability work. Co-Chair of the C2PA AI/ML Task Force, contributor to its Agentic Task Force, O'Reilly author of four books,
        ...
        <section className="section relevance-section" aria-labelledby="impact-heading">
          ...
          <ul className="impact-list">
            ...
            <li><strong>Supply chain grounding.</strong> Supply chain education through IBM programs, and enterprise blockchain work at Kilroy Blockchain built on provenance, traceability, and chain-of-custody &mdash; the canonical supply chain problem, approached from the side this team cares about: proving where something came from and what happened to it along the way.</li>
