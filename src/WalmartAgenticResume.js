      ...
      <main className="container" role="main" aria-label="Agentic AI platform resume of Karen Kilroy">
        ...
        <section className="section relevance-section" aria-labelledby="impact-heading">
          ...
          <ul className="impact-list">
            ...
            <li><strong>Supply chain grounding.</strong> Supply chain education through IBM programs, and supply chain blockchain systems built and shipped at Kilroy Blockchain &mdash; provenance, traceability, and chain of custody, which is to say proving where something came from and what happened to it in transit.</li>
