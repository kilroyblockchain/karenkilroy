      ...
      <main className="container" role="main" aria-label="Agentic AI platform resume of Karen Kilroy">
        ...
        <section className="section relevance-section" aria-labelledby="impact-heading">
          ...
          <ul className="impact-list">
            ...
            <li><strong>Supply chain grounding.</strong> Supply chain education through IBM Blockchain Supply Chain and IBM Food Trust, plus Oracle Intelligent Track and Trace &mdash; and supply chain blockchain systems built and shipped at Kilroy Blockchain. Provenance, traceability, and chain of custody: proving where something came from and what happened to it in transit.</li>
        ...
        <section className="section certifications" aria-labelledby="certifications-heading">
          ...
          <ul className="cert-list" aria-label="Certifications list">
            ...
            <li>IBM Blockchain Supply Chain &middot; IBM Food Trust &middot; Oracle Intelligent Track and Trace</li>
