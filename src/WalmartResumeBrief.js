      ...
      <main className="container" role="main" aria-label="Agentic AI systems resume of Karen Kilroy">
        ...
        <section className="section relevance-section" aria-labelledby="impact-heading">
          ...
          <ul className="impact-list">
            ...
            <li><strong>Supply chain grounding.</strong> Supply chain education through IBM Blockchain Supply Chain, IBM Food Trust, and Oracle Intelligent Track and Trace, plus supply chain blockchain systems built and shipped at Kilroy Blockchain &mdash; provenance, traceability, and chain of custody.</li>
        ...
        <section className="section certifications" aria-labelledby="certifications-heading">
          ...
          <ul className="cert-list" aria-label="Recognition and education list">
            ...
            <li>AI Fluency for Students and Teaching the AI Fluency Framework &mdash; Anthropic (2025) &middot; Venture Building &mdash; Builders + Backers (2025) &middot; IBM Blockchain Supply Chain &middot; IBM Food Trust &middot; Oracle Intelligent Track and Trace &middot; IBM Certifications: Watson Chatbot, RPA, Bluemix Essentials, Blockchain Essentials &middot; FAA Private Pilot License</li>
